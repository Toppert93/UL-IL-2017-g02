...
The \msrcode{is} operation has the following properties:
	...
	\addnumberedsinglerow{PostF}{ if the length of the value attribute of a dtAlertID is a ptInteger greater than zero and lower or equal to 30
	then the operation returns the ptBoolean true, else the ptBoolean false. }
